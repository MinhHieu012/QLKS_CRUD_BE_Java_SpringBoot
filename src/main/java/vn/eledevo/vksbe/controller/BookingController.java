...
public class BookingController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ApiResponse updateBooking(@PathVariable Long id, @RequestBody BookingUpdateRequest bookingUpdateRequest) throws ValidationException {
        return new ApiResponse<>(201, "Update booking success!", bookingService.updateBooking(id, bookingUpdateRequest));
    }
