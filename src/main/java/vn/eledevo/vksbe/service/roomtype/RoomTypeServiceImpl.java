...
public class RoomTypeServiceImpl implements RoomTypeService {
    ...
    public List<RoomTypeResponse> getAllRoomType() {
        ...
        List<RoomTypeResponse> roomTypeList = roomTypeListFromDB
                .stream()
    ...
    public RoomTypeResponse updateRoomType(Long id, RoomTypeRequest roomTypeRequest) throws ValidationException {
        ...
        RoomType roomType = repository.findById(id).orElseThrow(() -> new ValidationException("Room type", "Room type not found!"));
    ...
    public List<RoomTypeResponse> filterRoomType(
        ...
        Pageable roomTypePageable = PageRequest.of (
                page - 1, limit,
        ...
        List<RoomTypeResponse> roomTypeResponseList = roomTypeList
                .stream()
                .map(mapper::toResponse)
